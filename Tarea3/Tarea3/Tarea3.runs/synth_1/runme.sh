...
HD_PWD='D:/SuperDigitales/Tarea3/Tarea3/Tarea3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_tree.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_tree.tcl
