...
HD_PWD='D:/documentos/projectos_vivado/tarea_2/tarea_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UartRxHandler.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UartRxHandler.tcl -notrace
