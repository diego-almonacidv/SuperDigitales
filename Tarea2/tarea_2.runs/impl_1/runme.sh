...
HD_PWD='D:/documentos/repos/SuperDigitales/Tarea2/tarea_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CoProcessor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CoProcessor.tcl -notrace
