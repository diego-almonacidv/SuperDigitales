...
HD_PWD='D:/documentos/repos/SuperDigitales/Tarea2/tarea_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CoProcessor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CoProcessor.tcl
