...
HD_PWD='D:/documentos/projectos_vivado/tarea_2/tarea_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UartRxHandler.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UartRxHandler.tcl
